...
set "LOGFILE=%~dp0Package_Permissions.txt"

type nul > "%LOGFILE%"

echo Starting S.A.F.E. permission audit...
...
for %%P in (
    ...
    adb shell "dumpsys package %%P | grep permission" >> "%LOGFILE%"
...
echo ========================================
echo Permission audit complete! You can review Package_Permissions.txt in this folder.
pause